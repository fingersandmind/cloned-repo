            ...
            'exists'    => 'The :attribute not found in the system',
             ...
             if($validator->fails()){
                ...
                if($request->payment == "paypal"){
                    ...
                    DB::commit();
                    Mail::send('emails.register', ['email'=>$email,'company_name'=>$app_settings->company_name,'firstname'=>$data['firstname'],'name'=>$data['lastname'],'login_username' => $data['username'],'password'=> $data['password']], function ($m) use ($data , $email) {
