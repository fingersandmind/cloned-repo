        ...
        try {
            ...
            return Datatables::of($tickets)
                ...
                ->addColumn('action', function ($model) {
                    return '<div style="display: flex;" class="btn-group"> <a href="'.url('admin/helpdesk/ticket/'.$model->id).'" class="btn btn-success btn-info btn-xs btn-view-ticket" data-id="'.$model->id.'"> View </a> &nbsp; <a href="'.url('admin/helpdesk/ticket/'.$model->id).'/edit" class="btn btn-success btn-info btn-xs btn-edit-ticket" data-id="'.$model->id.'"> Edit </a>
                                    &nbsp;
