...
class ReportController extends AdminController
{
    ...
    public function joiningreportbysponsorview(Request $request)
    {
        ...
        $reportdata  = DB::table('users')->join('profile_infos', 'profile_infos.user_id', '=', 'users.id')->join('sponsortree', 'sponsortree.user_id', '=', 'users.id')->where('sponsortree.sponsor', '=', $sponsor_id)->get();
