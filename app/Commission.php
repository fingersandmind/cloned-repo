...
class Commission extends Model
{
   ...
   public static function Creditamounttowallet($data){

         
        SELF::create([
                'user_id'=>$data->username,
                'from_id'=>$data->username,
                'total_amount'=>$data->amount_usd,
                'tds'=>0,
                'service_charge'=>0,
                'payable_amount'=>$data->amount_usd,
                'payment_type'=>'fund_credited_using_'.$data->payment_method,
                ]);
        SELF::updateUserBalance($data->username,$data->amount_usd);
