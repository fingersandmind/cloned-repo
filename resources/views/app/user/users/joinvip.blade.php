...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">  Join Elite</h5>
      ...
      <div class="panel-body">
        <div class="col-sm-6">
            <form action="{{url('user/joinvip')}}" class="smart-wizard form-horizontal" method="post"  >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <span>You can join to the VIP / Elite matrix by paying $ {{ $matrix_fee }}</span>
