...
<div class="panel panel-flat">
    <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-sm-4">
            <a href="{{url('user/product/saleshistory?filter=approved')}}" class="btn btn-info"> Approved </a> <a href="{{url('user/product/saleshistory?filter=rejected')}}" class="btn btn-danger"> Rejected</a>            
          </div>          
        </div>
