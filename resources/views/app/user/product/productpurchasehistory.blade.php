               ...
               Zipcode : {{$datas->zipcode}}
                ...
                <td>
                  ...
                  <td>
                           ...
                           <a href="{{ url('user/product/approve/'.$datas->id) }}"
                                           class="btn btn-primary btn-sm"><i class="fa fa-check" aria-hidden="true"></i></a> 
                                ...
                                <div class="modal fade" id="myModal2{{$datas->id}}" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{URL::to('user/purchasedeleteconfirm')}}" method="post">
