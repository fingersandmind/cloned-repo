							...
							@if($voucher_count > 0)
								<thead class="">
									<tr>
										...
										<th>{{trans('ticket_config.voucher_amount')}}</th>
										<th>{{trans('ticket_config.count')}}</th>
										<th>{{trans('ticket_config.total_amount')}}</th>
								...
								<tbody>						
									...
									<td>
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal{{$request->id}}">{{trans('ticket_config.approve')}} </button>
									...
									<td>
											...
											<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal2{{$request->id}}">{{trans('ticket_config.delete')}} </button>
