            ...
            <input name="_token" type="hidden" value="{{csrf_token()}}"/>
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                <input autocomplete="off" class="form-control datetimepicker" id="start" name="start" required="true" type="text" value="{{date('Y-m-01')}}" />
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                <input autocomplete="off" class="form-control datetimepicker" id="end" name="end" required="true" type="text"  value="{{date('Y-m-t')}}" />
